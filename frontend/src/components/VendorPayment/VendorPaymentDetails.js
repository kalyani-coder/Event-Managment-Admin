...
const ViewVendorPayment = () => {
    ...
    const fetchVendorDetails = async () => {
        try {
            const response = await axios.get(`https://your-api-url.com/api/vendors/${vendorId}`);
        ...
        <div className="container mt-5">
            ...
            {vendorDetails && (
                <Card bg="info" text="white" className="mt-3 p-3">
                    <Card.Title>{vendorDetails.fname},{vendorDetails.lname}</Card.Title>
                    ...
                    <Card.Body>
                        ...
                        {vendorDetails.profilePicture && (
                            <Card.Img src={vendorDetails.profilePicture} alt="Profile" className="mb-3" />
                        )}
