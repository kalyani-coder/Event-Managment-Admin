...
const AddSalary = () => {
  ...
  useEffect(() => {
    fetch('https://eventmanagement-admin-hocm.onrender.com/api/managerdetails')
      .then(response => response.json())
      .then(data => setManagerOptions(data));

    fetch('https://eventmanagement-admin-hocm.onrender.com/api/accountant')
      .then(response => response.json())
      .then(data => setAccountantOptions(data));

    fetch('https://eventmanagement-admin-hocm.onrender.com/api/executive')
      .then(response => response.json())
