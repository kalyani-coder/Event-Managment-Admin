...
const Master = () => {
  ...
  const fetchBanks = async () => {
    try {
      const response = await fetch("https://node-backend.macj-abuyerschoice.com/api/allbanks");
      const data = await response.json();
      setBanks(data);
    } catch (error) {
  ...
  const fetchVenues = async () => {
    try {
      const response = await fetch("https://node-backend.macj-abuyerschoice.com/api/venue");
      const data = await response.json();
      setVenues(data);
    } catch (error) {
  ...
  const handleDeleteBank = async (bankId) => {
    ...
    if (confirmDelete) {
      try {
        const response = await fetch(
          `https://node-backend.macj-abuyerschoice.com/api/allbanks/${bankId}`,
          {
            method: "DELETE",
          }
        );
  ...
  const handleDeleteVenue = async (venueId) => {
    ...
    if (confirmDelete) {
      try {
        const response = await fetch(
          `https://node-backend.macj-abuyerschoice.com/api/venue/${venueId}`,
          {
            method: "DELETE",
          }
        );
